...
def mainMethod():
    ...
    graphData1 = (noPair1*numOfGamesToPlay/100, onePair1*numOfGamesToPlay/100, twoPair1*numOfGamesToPlay/100, threeOfKind1*numOfGamesToPlay/100, fullHouse1*numOfGamesToPlay/100, fourOfKind1*numOfGamesToPlay/100)
